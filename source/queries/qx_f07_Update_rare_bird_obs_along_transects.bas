...
dbText "Description" ="Reruns update of final UTMs for records associated with rare bird obs along tran"
    "sects to capture cases where the transect obs did not have a matching GPS Info r"
    "ecord"
