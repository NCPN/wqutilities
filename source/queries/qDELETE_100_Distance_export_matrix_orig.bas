Operation =1
Option =0
Where ="(((tbl_Observers.Observer_role)='Point count' Or (tbl_Observers.Observer_role) I"
    "s Null) AND ((tbl_Habitat.Habitat_num)=1 Or (tbl_Habitat.Habitat_num) Is Null) A"
    "ND ((tbl_Point_Counts.Flyover)=False))"
Begin InputTables
...
dbBinary "GUID" = Begin
    0xc18168d7595a274780ec8db4579e56ba
End
Begin
    Begin
