Operation =1
Option =0
Where ="(((tlu_Project_Taxa.Species_code) In (SELECT [Species_code] FROM [tlu_Project_Ta"
    "xa] As Tmp GROUP BY [Species_code] HAVING Count(*)>1 )))"
Begin InputTables
...
dbText "Description" ="Duplicates on species code"
Begin
End
Begin
    State =0
