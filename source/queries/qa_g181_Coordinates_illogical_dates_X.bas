Operation =1
Option =0
Where ="(((tbl_Coordinates.Coord_updated)<[Coord_created_date]))"
Begin InputTables
...
dbText "Description" ="Coordinates with updated dates before creation dates"
dbBinary "GUID" = Begin
    0x7d4819436f71834f98bc93128c8494dd
End
...
Begin
    ...
    End
    Begin
        dbText "Name" ="tbl_Coordinates.Coord_updated_by"
        dbInteger "ColumnWidth" ="1440"
        dbBoolean "ColumnHidden" ="0"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="tbl_Coordinates.Coord_updated"
        dbInteger "ColumnWidth" ="1440"
        dbBoolean "ColumnHidden" ="0"
        dbLong "AggregateType" ="-1"
    End
