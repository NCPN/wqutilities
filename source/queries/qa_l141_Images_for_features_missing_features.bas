Operation =1
Option =0
Where ="(((tbl_Images.Feature_ID) Is Not Null) AND ((tbl_Features.Feature_ID) Is Null))"
Begin InputTables
    Name ="tbl_Sites"
    Name ="tbl_Locations"
    Name ="tbl_Images"
...
Begin OutputColumns
    ...
    Expression ="tbl_Images.Feature_ID"
    Alias ="varAutoFix"
    Expression ="'qasub_Update_images_with_missing_features'"
    Alias ="varObject"
...
dbText "Description" ="Image records that have a value for Feature_ID that is not found in tbl_Features"
Begin
    Begin
    ...
    End
    Begin
        dbText "Name" ="tbl_Images.Image_filename"
