Operation =1
Option =0
Having ="(((tbl_Locations.Location_type)<>'Incidental'))"
Begin InputTables
    Name ="tbl_Sites"
    Name ="tbl_Locations"
    Name ="tbl_Events"
...
dbText "Description" ="List of points surveyed by year, where loc_type <> 'incidental'"
Begin
    Begin
        dbText "Name" ="Event_year"
        dbBinary "GUID" = Begin
            0x0d71f680c8fa01468f2a01354b1668f2
        End
    End
End
Begin
