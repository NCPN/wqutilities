Operation =1
Option =0
Where ="(((tbl_Coordinates.Field_offset_m) Is Not Null)) OR (((tbl_Coordinates.Field_off"
    "set_azimuth) Is Not Null))"
Begin InputTables
    Name ="tbl_Events"
...
dbText "Description" ="Coordinate records where the field offset fields are not null - all offsets from"
    " 2009 onward should already be automatically applied in the GPS unit"
